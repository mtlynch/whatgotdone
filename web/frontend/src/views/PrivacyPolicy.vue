<template>
  <div class="privacy-policy">
    ...
    <p>
      <a href="#caresidents">12. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a>
    </p>
    <p>
    ...
    <p>
      ...
      (your name, gender, birthday, email, current city, state and country, user identification numbers for your contacts, profile picture URL and any other information that you choose to make public)
    ...
    <p>
      ...
      <em>We only share information with your consent, to comply with laws, to protect your rights, or to fulfill business obligations.</em>
    </p>
    <br>
    ...
    <p>
      When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize it, or, if this is not possible (for example, because your personal information has been stored in backup archives), then we will securely store your personal information and isolate it from any further processing uize:15px;text-align:justify;"&gt;
    ...
    <div>P.O. Box 784</div>South Hadley
    ,
    MA
    01075
    <br>United States
